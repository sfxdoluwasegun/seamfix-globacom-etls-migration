...
public class MmsImpl implements CdrExtract {
	...
	public MmsImpl(String linedata) {
	...
	public UserState getUserState() {
		// TODO Auto-generated method stub
		try {
			return UserState.fromDigit(Integer.parseInt(linedata[58].substring(0, 1)));
		} catch (NumberFormatException e) {
			// TODO Auto-generated catch block
			return null;
		}
	...
	/**
	 * Retrieve type of message sent by subscriber.
	 * 
	 * @return message type
	 */
	public int getMessageType(){
		try {
			return Integer.parseInt(linedata[135]);
		} catch (NumberFormatException e) {
			// TODO Auto-generated catch block
			return 0;
		}
