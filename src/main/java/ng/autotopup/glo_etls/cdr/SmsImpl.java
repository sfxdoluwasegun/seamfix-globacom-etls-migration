...
import ng.autotopup.glo_etls.enums.SmsType;
import ng.autotopup.glo_etls.enums.UserState;

public class SmsImpl implements CdrExtract {
	...
	public SmsImpl(String linedata) {
	...
	public UserState getUserState() {
		// TODO Auto-generated method stub
		try {
			return UserState.fromDigit(Integer.parseInt(linedata[57].substring(0, 1)));
		} catch (NumberFormatException e) {
			// TODO Auto-generated catch block
			return null;
		}
	...
	public BigDecimal charge() {
		// TODO Auto-generated method stub
		try {
			return BigDecimal.valueOf(Double.parseDouble(linedata[63]));
		} catch (NumberFormatException e) {
			// TODO Auto-generated catch block
	...
	public BigDecimal accountBalance() {
		// TODO Auto-generated method stub
		try {
			return BigDecimal.valueOf(Double.parseDouble(linedata[64]));
		} catch (NumberFormatException e) {
			// TODO Auto-generated catch block
			return BigDecimal.ZERO;
		}
	...
	public PayType getPayType(){
		...
		try {
			return PayType.fromFlag(linedata[31]);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			return null;
		}
	...
	/**
	 * Retrieve type of SMS sent by subscriber.
	 * 
	 * @return sms type
	 */
	public SmsType getSmsType(){
		...
		try {
			return SmsType.fromType(Integer.parseInt(linedata[60]));
		} catch (NumberFormatException e) {
			// TODO Auto-generated catch block
			return null;
		}
